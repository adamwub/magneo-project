...
export const ERROR_CODES = {
  ...
  // Fase 2 — absensi QR (BAGIAN 10.2 & 12A.1)
  ATTENDANCE_INVALID_TOKEN: "ATTENDANCE_INVALID_TOKEN",
  ATTENDANCE_OUT_OF_AREA: "ATTENDANCE_OUT_OF_AREA",
  ATTENDANCE_LOCATION_REQUIRED: "ATTENDANCE_LOCATION_REQUIRED",

  // Fase 2 — izin (BAGIAN 10.3 & 12A.3)
  PERMIT_DUPLICATE: "PERMIT_DUPLICATE",
  PERMIT_INVALID_TRANSITION: "PERMIT_INVALID_TRANSITION",

  // Fase 2 — pengumuman (BAGIAN 10.6 & 12A.4)
  ANNOUNCEMENT_RETRACT_EXPIRED: "ANNOUNCEMENT_RETRACT_EXPIRED",
